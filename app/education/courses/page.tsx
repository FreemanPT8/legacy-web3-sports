...
export default function CoursesPage() {
  ...
  const nextStep = useMemo(() => {
    ...
    if (!nextLocked) {
      // tudo desbloqueado por XP (não significa concluído) -> sugere catálogo
      return {
    ...
    const desc =
      descriptionRaw ||
      tr(
        'courses.nextStep.defaultLockedDesc',
        'Este é o próximo desbloqueio lógico no teu patamar actual.',
      );
      ...
      <main className="flex-1 py-8">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-6xl space-y-10">
            ...
            {/* START HERE HERO (mantém, mas dentro do sistema visual) */}
            <section className={cn(UI.panel, 'px-6 py-8')}>
              <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="relative space-y-3">
                  ...
                  <p className={UI.sectionSubtitle}>
                    {tr(
                      ...
                      'Se estás no início, volta ao “Percurso sugerido”. É onde ganhas base mais rápido — e com menos ruído.',
                    )}
                  </p>
                </div>
              </section>
        ...
        {/* NEXT UNLOCK CTA (mantém fora do max-w-6xl, mas coerente) */}
