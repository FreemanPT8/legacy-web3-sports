    ...
    try {
      ...
      if (data.success) {
        toast({
          ...
          description: data.xpEarned ? `Your changes have been saved. +${data.xpEarned} XP earned!` : 'Your changes have been saved successfully.',
        });
      } else {
        toast({
          title: 'Error',
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8 flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">Manage your personal information and privacy settings</p>
              </div>
              <div className="text-right">
                <div className="text-2xl font-bold text-blue-600">{user.xp_total} XP</div>
                <p className="text-sm text-gray-600 dark:text-gray-300">Level {Math.floor(user.xp_total / 100)}</p>
              </div>
            </div>
              ...
              <Card className="mb-6 border-2 border-yellow-500 bg-yellow-50">
                <CardHeader>
                  ...
                  <CardDescription className="text-yellow-700">
                    Earn {99 - user.xp_total} more XP to unlock full profile editing capabilities
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-2 mb-2">
                    <div className="flex-1 bg-yellow-200 rounded-full h-3">
                      <div
                        ...
                        style={{ width: `${Math.min((user.xp_total / 99) * 100, 100)}%` }}
                      />
                    </div>
                    <span className="text-sm font-semibold text-yellow-800">{user.xp_total}/99</span>
                  </div>
                </CardContent>
              </Card>
            )}
            ...
            <Card className="mb-6">
              <CardHeader>
                ...
                <CardDescription>Public information visible to all users</CardDescription>
              </CardHeader>
            ...
            <Card className="mb-6">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Profile Details {!isUnlocked && <Lock className="h-4 w-4 text-gray-400" />}
                </CardTitle>
                <CardDescription>
                  Earn XP by completing your profile. Toggle visibility for each field.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge variant="outline" className="text-green-600">+{xpRewards.bio} XP</Badge>
                      <Switch
                        checked={profileData.profile_visibility.bio}
                        onCheckedChange={(checked) =>
                          setProfileData({
                            ...profileData,
                            profile_visibility: { ...profileData.profile_visibility, bio: checked }
                          })
                        }
                        disabled={!isUnlocked}
                      />
                  ...
                  <Textarea
                    ...
                    maxLength={888}
                  />
                  <p className="text-xs text-gray-500">{profileData.bio.length}/888 characters</p>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge variant="outline" className="text-green-600">+{xpRewards.sports_role} XP</Badge>
                      <Switch
                        checked={profileData.profile_visibility.sports_role}
                        onCheckedChange={(checked) =>
                          setProfileData({
                            ...profileData,
                            profile_visibility: { ...profileData.profile_visibility, sports_role: checked }
                          })
                        }
                        disabled={!isUnlocked}
                      />
                    ...
                    <div key={field.key} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Switch
                            checked={profileData.profile_visibility[field.key as keyof typeof profileData.profile_visibility]}
                            onCheckedChange={(checked) =>
                              setProfileData({
                                ...profileData,
                                profile_visibility: {
            ...
            <Card className="mb-6 bg-gradient-to-br from-blue-50 to-cyan-50">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
                  Complete your profile fields to earn bonus XP! Each field is awarded once.
                </p>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {Object.entries(xpRewards).map(([key, xp]) => (
                    <div key={key} className="bg-white p-3 rounded-lg text-center">
                      <div className="text-xl font-bold text-blue-600">+{xp}</div>
