        ...
        <PageShell className="flex-1">
          <Card className="mx-auto max-w-xl border border-white/10 bg-[#000c12] shadow-[0_30px_60px_rgba(0,0,0,0.50)]">
            <CardHeader className="text-center space-y-3">
              ...
              <CardTitle className="text-2xl text-white">{t('forum.forumLocked')}</CardTitle>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="flex-1 bg-[#05212b] rounded-full h-2">
                  <div
  ...
  return (
    <div className="min-h-screen bg-[#000c12] text-white">
      ...
      <PageShell className="space-y-10 py-10">
        <PageHeader
          title={t('forum.communityForum')}
          description={t('forum.communityForumDesc')}
          actions={
        ...
        <section className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {rooms.map((room) => {
              ...
              return (
                <Card key={room.title} className="border border-white/10 bg-[#000c12]">
                  <CardHeader>
                    <div className="flex items-center justify-between mb-2">
              ...
              >
                <CardHeader>
                  <div className="flex items-center justify-between mb-2">
                    <Badge
                      variant="outline"
                      className="border-white/30 text-slate-300 bg-transparent"
                    >
                      House
                    </Badge>
