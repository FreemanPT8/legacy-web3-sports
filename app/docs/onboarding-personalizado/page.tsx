...
const sections = [
  ...
  },
  {
    ...
    description:
      'Indicadores mínimos para manter o estatuto de House ativa.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'Táticas para entregar valor sem entrar em modo "suporte 24/7".',
    bullets: [
  ...
  },
  {
    ...
    description:
      'Confirma a leitura deste guia e regressa ao painel para gerir sequências e convites.',
    bullets: [
