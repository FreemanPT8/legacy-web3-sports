              ...
              <div className="lg:col-span-2 space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      <Label>Excerpt ({languages.find(l => l.code === currentLanguage)?.name})</Label>
                      <Textarea
                    ...
                    <div>
                      <Label>Content ({languages.find(l => l.code === currentLanguage)?.name})</Label>
                      <Textarea
              ...
              <div className="space-y-6">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setPost({ ...post, reading_time: parseInt(e.target.value) || 0 })}
                        min="1"
                        max="60"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setPost({ ...post, xp_reward: parseInt(e.target.value) || 0 })}
                        min="5"
                        max="50"
                      />
                    </div>
                ...
                <Card className="bg-blue-50">
                  ...
                  <CardContent className="space-y-2 text-sm text-gray-700">
                    ...
                    <p>• Include examples and code snippets when relevant</p>
