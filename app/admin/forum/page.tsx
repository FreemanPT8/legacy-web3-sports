...
import { ArrowLeft, MessageSquare, Lock, Unlock, Pin, Trash2 } from 'lucide-react';
            ...
            <div className="mb-8">
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Monitor and moderate forum discussions</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-300">Total Rooms</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-300">Topics</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-300">Members Unlocked</CardTitle>
                </CardHeader>
                <CardContent>
