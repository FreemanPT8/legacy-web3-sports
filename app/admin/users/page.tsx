...
import { ArrowLeft, Search, Users, Trophy, Mail, Calendar, Eye, Edit, X } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">View and manage user accounts, roles, and permissions</p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-8">
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-300">Super Admins</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-300">Admins</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-300">Members</CardTitle>
                </CardHeader>
                <CardContent>
                            ...
                            <td className="py-3 px-4">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  {u.full_name && (
                                    <p className="text-sm text-gray-600 dark:text-gray-300">{u.full_name}</p>
                                  )}
                                </div>
                              </div>
                            </td>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge className={viewUserModal.role === 'Super Admin' ? 'bg-purple-600' : viewUserModal.role === 'Admin' ? 'bg-blue-600' : 'bg-gray-600'}>
                    {viewUserModal.role}
                  </Badge>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm">{new Date(viewUserModal.created_at).toLocaleDateString()}</p>
                </div>
                <div>
                  <Label className="text-sm font-semibold">Last Login</Label>
                  <p className="text-sm">{viewUserModal.last_login ? new Date(viewUserModal.last_login).toLocaleDateString() : 'Never'}</p>
                </div>
              </div>
              {viewUserModal.bio && (
                <div>
          ...
          {editUserModal && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm">{editUserModal.username} ({editUserModal.email})</p>
              </div>
              <div>
                ...
                {user?.role !== 'Super Admin' && (
                  <p className="text-xs text-gray-500 mt-1">Only Super Admins can assign Super Admin role</p>
                )}
              </div>
              <div>
                <Label htmlFor="xp" className="text-sm font-semibold">Total XP</Label>
                <Input
                  id="xp"
                  type="number"
                  value={editXP}
