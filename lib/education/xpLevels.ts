export const XP_LEVELS = [
  { key: 'newcomer', min: 0, max: 98, label: 'Cadete', range: '0-98 XP' },
  { key: 'beginner', min: 99, max: 368, label: 'Infantil', range: '99-368 XP' },
  ...
  { key: 'expert', min: 2222, max: 3332, label: 'S?nior', range: '2,222-3,332 XP' },
